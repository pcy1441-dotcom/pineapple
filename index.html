...
const skills = {
  murder: [
    ...
    { name: "가방", desc: "자신이 죽인 사람에게 죽지않은 것처럼 평소대로 돌아다니다가 마지막에 죽으라고 명령합니다.(1명 한정)." },
    { name: "무능력", desc: "능력이 없습니다." },
    { name: "총잡이", desc: "보안관의 방식으로 죽입니다.(어깨 터치)." },
    { name: "무능력", desc: "능력이 없습니다." },
    { name: "무능력", desc: "능력이 없습니다." }
  ],
  sheriff: [
  ...
  doctor: [
    ...
    { name: "구급상자", desc: "1명의 생존자에게 미리 지급해 스스로 치유할 수 있게 합니다.(머더 포함)" },
    { name: "무능력", desc: "능력이 없습니다." }
  ],
  citizen: [
    { name: "무능력", desc: "능력이 없습니다." },
    { name: "스파이", desc: "시민/보안관을 죽일수록 최대 2목숨까지 쌓입니다. 머더를 죽이면 자신도 죽으며 시민 승리." },
